...
export const CURATED_LOGIC_PUZZLES: Puzzle[] = [
	...
	mc({
		...
		difficulty: 3,
		prompt:
			'У Кати есть брат и сестра. У её брата столько же сестёр, сколько братьев. Сколько всего детей в семье?',
		options: [
			{ id: 'a', label: '3' },
			{ id: 'b', label: '4' },
			{ id: 'c', label: '5' },
		...
		answer: 'b',
		hints: [
			{ level: 1, text: 'У Кати уже брат и сестра — минимум трое.' },
			{
				level: 2,
				text: 'У брата 2 сестры и 1 брат (кроме него) → 2 девочки и 2 мальчика.',
			},
		],
		explanation:
			'Две девочки и два мальчика. У брата две сестры и один брат — числа равны. Всего четверо.',
		tags: ['curated', 'logic', 'relations'],
	}),
	mc({
	...
	mc({
		...
		difficulty: 4,
		prompt:
			'Школа севернее парка. Магазин восточнее школы. Где магазин относительно парка?',
		options: [
		...
		hints: [
			...
			{ level: 2, text: 'От школы к магазину — на восток → от парка на СВ.' },
		],
		explanation:
			'Школа севернее парка, магазин восточнее школы — магазин северо-восточнее парка.',
		tags: ['curated', 'logic', 'directions'],
	}),
	mc({
